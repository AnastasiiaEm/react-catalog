...
export const ShopByCategory = () => {
  ...
  return (
    <div className="category">
      ...
      <div className="category__content" data-cy="categoryLinksContainer">
        <div>
          <Link to="/phones">
            <img
          ...
          <Link to="/phones" className="category__category-link">
            <h3 className="category__category-name">Mobile phones</h3>
          </Link>
        ...
        <div>
          ...
          <Link to="/tablets" className="category__category-link">
            <h3 className="category__category-name">Tablets</h3>
          </Link>
        ...
        <div>
          ...
          <Link to="/accessories" className="category__category-link">
            <h3 className="category__category-name">Accessories</h3>
          </Link>
