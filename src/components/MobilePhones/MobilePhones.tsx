...
export const MobilePhones: React.FC<Props> = ({ phones }) => {
  const productsAmount = phones.filter(
    ...
    <div className="mobile-phones">
      {isSearchEmpty && (
        <div className="mobile-phones__page-details">
          ...
          <span className="mobile-phones__models-amount">
      ...
      {!isSearchEmpty && (
        <div className="mobile-phones__search-results">
          <span className="mobile-phones__search-results-amount">
      ...
      <div data-cy="productList">
        <div className="mobile-phones__products">
